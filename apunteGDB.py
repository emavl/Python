...
print("verifico que sean del tipo list:")
print(type(mi_lista))
...
print("\ninicio:final:paso (el valor de paso no se imprimiria o le aumento +1 a la posicion que quiero)")
...
for i in range(len(lista_paralela_1)):
    #deberia mostrar 1 con "a", 2 con "b" y 3 con "c"
    print(f"nota: {lista_paralela_1[i]} - letra: {lista_paralela_2[i]}")    
...
print("mostrar el diccionario con el elemento agregado y modificado:")
print(diccionario)

print("\npreguntar si un determinado elemento existe en el dict:"
      "\n ----> if 'clave2' in diccionario, devolviendome  True or False")
