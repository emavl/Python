        ...
        match menu_personas():
            ...
            case 2:
                if (flag_traer_datos):
                    ...
                    print(
                        "No se puede listar cantidad por marca si primero no se cargan los datos desde el archivo.")
            case 3:
                if (flag_traer_datos):
                    listar_insumos_por_marca(insumos)
                else:
                    print(
                        "No se puede listar insumos por marca si primero no se cargan los datos desde el archivo.")
            case 4:
                if (flag_traer_datos):
                    buscar_insumo_por_caracteristica(insumos)
                else:
                    print(
                        "No se puede buscar insumo por caracteristica si primero no se cargan los datos desde el archivo.")
            case 5:
                if (flag_traer_datos):
                    listar_insumos_ordenados(insumos)
                else:
                    print(
                        "No se puede listar insumos ordenados si primero no se cargan los datos desde el archivo.")
            case 6:
                if (flag_traer_datos):
                    realizar_compras(insumos)
                else:
                    print(
                        "No se puede realizar compras si primero no se cargan los datos desde el archivo.")
            case 7:
                formato_exportacion = input(
                    "Seleccione el tipo de formato de exportación (csv/json): ")
                if formato_exportacion.lower() == 'csv':
                    ...
                    if (flag_traer_datos):
                        ...
                        print(
                            "No se puede guardar json si primero no se cargan los datos desde el archivo.")
                else:
            ...
            case 9:
                if (flag_traer_datos):
                    ...
                    print(
                        "No se puede actualizar precios si primero no se cargan los datos desde el archivo.")
            case 10:
            ...
            case _:
                print(
                    "Opción invalida. Por favor, seleccione una opcion valida del menu.")
...
def listar_insumos_ordenados(insumos):
    ...
    for insumo in ordenados:
        ...
        print(
            f"{insumo[0]} - {insumo[1]} - {insumo[2]} - {insumo[3]} - {caracteristicas}")
...
def realizar_compras(insumos):
    ...
    while True:
        ...
        opcion = input(
            "Seleccione el insumo que desea comprar (ingrese el número): ")
        ...
        total += subtotal
        carrito[insumo_seleccionado[1]] = {
            'cantidad': int(cantidad), 'subtotal': subtotal}
    ...
    nombre_archivo = input(
        "Ingrese el nombre del archivo para guardar la factura (sin extensión): ")
    ...
    with open(archivo_factura, "w") as archivo:
        ...
        for nombre, detalle in carrito.items():
            archivo.write(
                f"{detalle['cantidad']} x {nombre} - ${detalle['subtotal']}\n")
        archivo.write(f"Total: ${total}\n")

    print(
        f"La factura se ha generado y guardado en el archivo {archivo_factura}.")
