...
def ejecutar_menu():
    opcion = pedir_caracter("=================================\n"
                                  "         Stark Industries        \n"
                                  "=================================\n"
                                  "a) listar por héroe por genero M \n"
                                  "b) listar por héroe por genero F \n"
                                  "c) Héroe más alto\n"
                                  "d) Heroína mas alta\n"
                                  "e) Heroína mas baja\n"
                                  "f) Promedio altura de los héroes\n"
                                  "g) Promedio altura de las heroínas\n"
                                  "h) Nombre del superhéroe asociado a los puntos ( 3 a 6 )\n"
                                  ...
                                  "l) Listar por tipo de inteligencia 'si lo tiene'\n"
                                  "m) Listar todos los superhéroes agrupados por color de ojos.\n"
                                  "n) Listar todos los superhéroes agrupados por color de pelo.\n"
                                  "ñ) Listar todos los superhéroes agrupados por tipo de inteligencia.\n"
                                  "o) salir.\n"
                                  "\n opcion n° ────► ",
...
# ------------- N o m b r e   a s o c i a d o  --------------


def nombre_asoci(lista: list[dict]) -> None:
    altura = lista_por_alturas(lista, 'M')
    set_alturas(altura)
